...
Open your browser to interact with vLLM
----

. Verify the web UI is accessible by opening your browser to:
+
...
+
// TODO: Add screenshot
image::vllm-playground-home.png[vLLM Playground home page showing the main interface,width=700,title="vLLM Playground Home Page"]

. In the vLLM Playground web interface, configure your first model:
+
.. Navigate to *Server Configuration* section
.. In the *Model* field, enter a model ID (e.g., `TinyLlama/TinyLlama-1.1B-Chat-v1.0` for quick testing)
