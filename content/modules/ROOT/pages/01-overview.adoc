...
You're a senior AI engineer at ACME Corporation, and you've been assigned to evaluate and implement an AI-powered customer support system that can serve multiple Large Language Models (LLMs) efficiently.
...
**Your assignment**: Evaluate vLLM Playground as the foundation for ACME's AI customer support system, demonstrating its capabilities for model serving, tool calling, and agentic workflows.

**The objective**: Prove that vLLM Playground can deliver high-performance LLM inference with advanced features like structured outputs, tool calling, and MCP integration.
...
**Technical outcome**: You'll have hands-on experience with vLLM Playground that directly applies to ACME's AI infrastructure requirements.
...
**Project timeline**: Evaluate vLLM Playground and demonstrate its capabilities for ACME's enterprise AI requirements.
