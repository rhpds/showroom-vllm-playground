...
+
image::module-03-figure-04.png[Four customer support tools defined,align="center",width=600,link=module-03-figure-04.png^,title="Defined Tools"]
...
----
+
image::module-03-figure-05.png[AI generating a tool call for order status,align="center",width=700,link=module-03-figure-05.png^,title="Tool Call Generated"]
+
...
----
+
image::module-03-figure-06.png[AI generating a tool call for customer lookup,align="center",width=700,link=module-03-figure-06.png^,title="Customer Lookup Tool Call"]
...
----
+
image::module-03-figure-07.png[AI generating a tool call for callback scheduling,align="center",width=700,link=module-03-figure-07.png^,title="Callback Scheduling Tool Call"]
...
----
+
image::module-03-figure-08.png[AI generating a tool call for product search,align="center",width=700,link=module-03-figure-08.png^,title="Product Search Tool Call"]
...
+
image::module-03-figure-09.png[AI handling multiple tool calls in a single request,align="center",width=700,link=module-03-figure-09.png^,title="Multiple Tool Calls"]
