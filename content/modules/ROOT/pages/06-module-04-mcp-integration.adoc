...
+
image::module-04-figure-03.png[Time server connected showing available tools,width=500,title="Time Server Connected"]
...
+
image::module-04-figure-04.png[Enable MCP tools in Chat panel,width=500,title="Enable MCP Tools"]
...
+
image::module-04-figure-05.png[Human-in-the-loop approval dialog,width=500,title="Tool Approval Dialog"]

. When prompted for approval, review the tool call and click *Execute*.
+
image::module-04-figure-06.png[AI response after human-in-the-loop approval,width=600,title="AI Response After Approval"]

. Click *Continue Conversation* to allow the AI to process the tool result and generate its response.
+
image::module-04-figure-07.png[AI response with time information,width=600,title="AI Response with Time Information"]
...
+
image::module-04-figure-08.png[Filesystem server configuration,width=500,title="Filesystem Configuration"]
+
[cols="1,2"]
|===
|Setting |Value
...
+
image::module-04-figure-09.png[Filesystem server connected,width=500,title="Filesystem Server Connected"]
...
+
image::module-04-figure-10.png[AI response after file read approval,width=600,title="AI Response After File Read"]
...
+
image::module-04-figure-11.png[Directory listing response,width=600,title="Directory Listing Response"]
...
+
image::module-04-figure-12.png[Document analysis response,width=600,title="Document Analysis Response"]
...
+
image::module-04-figure-13.png[Multiple tool calls in an agentic workflow,width=700,title="Agentic Workflow with Multiple Tools"]
+
...
+
image::module-04-figure-14.png[Safety controls preventing unauthorized file access,width=600,title="Safety Controls in Action"]
