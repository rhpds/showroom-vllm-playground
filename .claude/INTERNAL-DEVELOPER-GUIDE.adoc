...
### 1. `lab-module` - Workshop Module Generator

**File**: `.claude/skills/lab-module/SKILL.md`
...
**Files Read**:
- `.claude/skills/lab-module/SKILL.md`
...
### 2. `demo-module` - Demo Content Generator

**File**: `.claude/skills/demo-module/SKILL.md`
...
**Files Read**:
- `.claude/skills/demo-module/SKILL.md`
- `.claude/docs/SKILL-COMMON-RULES.md`
- `.claude/prompts/redhat_style_guide_validation.txt`
- `content/modules/ROOT/pages/demo/example/`

**Files Written**:
- Demo module files (similar structure to lab-module)
- `content/modules/ROOT/nav.adoc` (updated)
...
Both `lab-module` and `demo-module` offer **optional** AgV catalog assistance (Step 2.5).
...
- Created lab-module, demo-module, verify-content skills
...
### Skill Definitions
- [lab-module SKILL.md](skills/lab-module/SKILL.md)
- [demo-module SKILL.md](skills/demo-module/SKILL.md)
